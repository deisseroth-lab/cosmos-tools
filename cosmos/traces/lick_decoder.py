...
class LickDecoder:
    ...
    def __init__(self, dataset_id, CT, decoding_save_dir,
        ...
        self.data_opts = {'decoding_set': 1, # ID number of which data labeling to decode.
                                             # See get_data_for_decoding for details.
                         'train_feat': 'spikes', # 'spikes', 'smooth_spikes', or 'fluor', 'spikes_binarized'
                         'train_frac': 0.5,
                         'test_frac': 0.25,
                         'valid_frac': 0.25,
                         ...
                         'standardize_X': True,  # u=0, s=1  ### Changed this on 20190820
                         'center_Y': True}  # u=0
    ...
    def get_source_discriminativity(self):
        ...
        :return:
        """
        du.get_source_discriminativity(self.data_split, self.CT, self.data_opts,
    ...
    def decode_licks(self, expt_group_id, nfolds,
        ...
        :param n_pca_components: int. If do_pca, then how many components to use.
        :param do_shuffle_data: bool. If true, then shuffles the labels
        ...
        for fold_number in range(nfolds):
            ...
            p_ordering, minpvals = du.get_source_discriminativity(data_split,
                                                        self.CT,
                                                        self.data_opts,
                                                        self.decoding_save_dir,
                                                        do_plot=False)
