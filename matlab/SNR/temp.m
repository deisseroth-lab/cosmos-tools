%%%% This script computes the PNR (peak-to-noise ratio) and correlation image 
...
% % %     {'20170713', 'cux2_post_8dayspst_tamox_30hz_50mW_f1.4_1', 'f1.4', 1}; 
% % %     {'20170713', 'cux2_post_8dayspst_tamox_30hz_50mW_f2.8_1', 'f2.8', 1}; 
% % %     {'20170713', 'cux2_post_8dayspst_tamox_30hz_50mW_f4_1', 'f4', 1};...
% % %     {'20170713', 'cux2_post_8dayspst_tamox_30hz_50mW_f5.6_1', 'f5.6', 1}; ...
% % %     {'20170713', 'cux2_post_8dayspst_tamox_30hz_50mW_f8_1', 'f8', 1}; ...
...
if doSelectCrop
    ...
    for kk = 1:numel(templates)
        if ~isempty(templates{kk})
            ...
            if doSelectAll %%%% Select all of the ROIs individually
                for nn = 1:nCropROIs
                    cc = getrect;
%                     cc(3) = 35;
%     %                 cc(4) = 250;
