function neuron = batch_cnmfe_2P(nam)
    ...
    % -------------------------      SPATIAL      -------------------------  %
    gSig = 0;           % pixel, gaussian width of a gaussian kernel for filtering the data. 0 means no filtering
    gSiz = 5;           % pixel, neuron diameter 
    ...
    min_corr = 0.02;    % minimum local correlation for a seeding pixel was .05
    min_pnr = 10        % minimum peak-to-noise ratio for a seeding pixel 15
